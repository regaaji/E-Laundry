              ...
              <table class="table table-hover table-responsive" id="example2">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url() ?>admin/essii/aksi/<?= $ba['id_transaksi']; ?>" class="btn btn-warning btn-sm"> Lihat Status</a>
                      <a href="<?= base_url() ?>admin/essii/hapustransaksi/<?= $ba['id_transaksi']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                  <?php endforeach; ?>
