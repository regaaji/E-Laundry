          ...
          <h1 class="h3 mb-4 text-gray-800"><?= $title; ?></h1>
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="card">
						<div class="card-body">
							<h5 class="font-weight-bold pb-2">Data Transaksi Wipe</h5>
                    ...
                    <td>
                      <a href="<?= base_url() ?>admin/wipe/aksi/<?= $ba['id_transaksi']; ?>" class="btn btn-warning btn-sm"> Lihat Status</a>
                      <a href="<?= base_url() ?>admin/wipe/hapustransaksi/<?= $ba['id_transaksi']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                    </td>
									</tr>
									<?php $i++; ?>
									<?php endforeach; ?>
