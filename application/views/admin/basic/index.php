				...
				<div class="col-lg-8">
					<div class="card">
						<div class="card-body">
							...
							<h5 class="font-weight-bold">Data Barang Basic</h5>
							...
							<table class="table table-hover table-responsive" id="example2">
								...
								<tbody>
									<?php $i = 1; ?>
									<?php foreach( $basic as $ba ) : ?>
										<tr>
											<th scope="row"><?= $i; ?></th>
											<td><?= $ba['nama_produk']; ?></td>
											<td><?= $ba['harga']; ?></td>
											<td><img src="<?= base_url('assets/img/'); ?><?= $ba['gambar']; ?>" class="rounded-circle" width="50" height="50" alt=""></td>
											<td>
												<span class="badge badge-sm badge-success"><?= $ba['nama_status']; ?></span>
											</td>
											
											<td>
												<a href="<?= base_url(); ?>admin/basic/edit/<?= $ba['id_produk']; ?>" class="badge badge-primary">ubah</a>
												<a href="<?= base_url(); ?>admin/basic/hapus/<?= $ba['id_produk']; ?>" class="badge badge-danger">hapus</a>
											</td>
										</tr>
										<?php $i++; ?>
									<?php endforeach; ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form method="post" action="<?= base_url(); ?>admin/basic/" enctype="multipart/form-data">
      		...
      		<div class="form-group">
      			...
      			<input type="hidden" name="status_barang_id" value="1" id="status_barang_id">
      		</div>
      </div>
