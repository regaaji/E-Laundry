                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="<?= base_url(); ?>admin/menu/editsubmenu/<?= $sm['id']; ?>" class="badge badge-success">Edit</a>
                                <a href="<?= base_url(); ?>admin/menu/deletesubmenu/<?= $sm['id']; ?>" class="badge badge-danger">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <form action="<?= base_url('admin/menu/submenu'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <p>Berdasarkan icon yang <a href="https://fontawesome.com/icons?d=gallery&m=free">ini</a></p>
                    </div>
