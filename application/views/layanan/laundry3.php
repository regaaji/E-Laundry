        ...
        <div class="col-md-8">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php foreach ($produk1 as $row) : ?>
                 <div class="product">
                  <div class="product-image">
                    <img class="rounded-circle" src="<?= base_url() ?>assets/img/essii/<?= $row->produk_image; ?>">
                  </div>
                  <div class="product-details">
                    <div class="product-title"><?php echo $row->produk_nama;?></div>
                    <p class="product-description"><?php echo 'Rp '.number_format($row->produk_harga);?></p>
                  </div>
                  <div class="product-price font-weight-bold"><?php echo 'Rp '.number_format($row->produk_harga);?></div>
                  <div class="product-quantity">
                    <input type="number" name="quantity" id="<?php echo $row->produk_id;?>" value="1" class="quantity" size="20">
                  </div>

                 <button class="add_cart btn btn-primary"  data-produkid="<?php echo $row->produk_id;?>" data-produknama="<?php echo $row->produk_nama;?>" data-produkharga="<?php echo $row->produk_harga;?>" type="button" >Tambah List</button>
                </div>
                <?php endforeach;?>
                  ...
                  <table class="table table-striped ">
                    ...
                    <tbody id="detail_cart">
                      <tr>
                        ...
                        <th colspan="2" name="harga1"><?php $subtotal= number_format($this->cart->total()) ?></th>
                      </tr>
                    </tbody>
              ...
              <input type="hidden"  name="harga1" id="subtotal" value="<?= $subtotal; ?>">
