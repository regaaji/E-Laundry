            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col">
                  <p class="font-weight-bold">Detail Penjemputan</p>
                   <p><?= $this->session->userdata('tanggal_jemput1'); ?> : <?= $this->session->userdata('waktu_jemput'); ?></p>
                   <input type="hidden" name="tanggal_jemput1" value="<?= $this->session->userdata('tanggal_jemput1'); ?>">
                   <input type="hidden" name="waktu_jemput1" value="<?= $this->session->userdata('waktu_jemput1'); ?>">
                </div>
                <div class="col">
                  <p class="font-weight-bold">Detail Pengiriman</p>
                  <p><?= $this->session->userdata('tanggal_kirim1'); ?> : <?= $this->session->userdata('waktu_kirim1'); ?></p>
                  <input type="hidden" name="tanggal_kirim1" value="<?= $this->session->userdata('tanggal_kirim1'); ?>">
                   <input type="hidden" name="waktu_kirim1" value="<?= $this->session->userdata('waktu_kirim1'); ?>">
                </div>
                <div class="col">
              ...
              <div class="row mt-3">
                <div class="col">
                 ...
                 <p><?= $this->session->userdata('location1'); ?></p>
                 <input type="hidden" name="location1" value="<?= $this->session->userdata('location1'); ?>">
                </div>
                <div class="col-lg">
                  <p class="font-weight-bold">Rincian Alamat</p>  
                 <p><?= $this->session->userdata('alamat1'); ?></p>
                </div>
                
                 <div class="col">
                  <input type="hidden" name="alamat1" value="<?= $this->session->userdata('alamat1'); ?>">
                  <input type="hidden" name="status1" value="Belum Lunas">
                  <input type="hidden" name="harga1" value="<?= $this->session->userdata('harga1'); ?>">
                  <input type="hidden" name="uang1" value="Non Tunai">
                </div>
