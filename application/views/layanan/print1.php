...
<body>
  ...
  <br>
      ...
      <div class="harga">Rp. <?=  $detail['harga1']; ?></div>
      <div class="tanggal1"><?= $detail['uang1']; ?></div>
      ...
      <div class="kontak1">
        ...
        <div id="namaP">
         <?=  $detail['tanggal_kirim1']; ?> / <?=  $detail['waktu_kirim1']; ?>
        </div>
        
        <div class="garis1"></div>
        <div class="nama_handphone1">Detail Penjemputan :</div>
        <div id="namaHp">
         <?=  $detail['tanggal_jemput1']; ?> / <?=  $detail['waktu_jemput1']; ?>
        </div>
