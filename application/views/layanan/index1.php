        ...
        <div class="col-md-8">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <h2 class="card-title text-primary animated bounceInDown" style="animation-duration: 2s;">Basic Laundry <span class="badge badge-primary" style="font-size: 20px;"><i class="fa fa-user pr-1"></i><?= $jumlah; ?> / 10</span></h2>
                <hr>
              ...
              <div class="mt-5">
               <label class="product-image"></label>
                    ...
                    <?php foreach ($barang as $se) : ?>
                        <div class="product">
                            <div class="product-image">
                                <img class="rounded-circle" src="<?= base_url(); ?>assets/img/<?= $se['gambar']; ?>">
                            </div>
                        ...
                        <div class="price-row">
                            <span class="minus-plus-input">
                                ...
                                <input name='quantity' value='0' class='qty float-right' size="10" />
                            ...
                            <div class="tampilnama" style="margin-top: -50px;"><?= $se['nama']; ?></div>    
...
<form action="" method="post">
            ...
            <div class="modal-footer">
              ...
              <?php if($jumlah == 10) : ?>
                <button type="button" class="btn btn-danger" onclick="njajal()">Penuh <i class="fa fa-times-circle" style="padding-left: 10px;"></i></button>
               <?php else : ?> 
