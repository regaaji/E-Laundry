   ...
   <div class="row">
      <div class="col-md-10 offset-md-1">
         ...
         <div class="card-body">
            ...
            <input type="text" class="form-control text-right font-weight-bold bg-white text-primary" value="Rp. <?= $this->session->userdata('harga'); ?>" readonly>
            <a href="../ExpressBayar1/"><button class="btn btn-success mt-3 mr-2"><i class="fa fa-money pr-1"></i>Tunai</button></a>
            ...
            <div class="collapse" id="collapseExample">
               <div class="card card-body mt-3">
                ...
                <p class="font-weight-bold">Kirim ke Rekening : <span class="badge badge-primary" style="font-size: 15px; font-family: verdana;">BRI</span> </p>
                   <div class="row">
                    <div class="col-lg-2">
                       <a href="../ExpressBayar2/"><button class="btn btn-primary mr-5"><i class="fa fa-send pr-1"></i>Kirim</button></a>
                    </div>
                 </div>
             </div>
          </div>
